...
##### For future updates, add in the new year's data as a .text file and update file paths as neccesary. I've created functions to iteratively handle compiling each year into a clean data object. 
